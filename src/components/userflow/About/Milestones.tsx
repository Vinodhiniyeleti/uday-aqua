...
const aboutCards = [
  {
    ...
    largeDesc: "From launching our first project to expanding across India, each milestone marks a step forward in our journey.",
    img: milestoneImg
  },
  {
    ...
    largeDesc: "Uday Aqua has received numerous awards for innovation, sustainability, and community impact.",
  },
  {
